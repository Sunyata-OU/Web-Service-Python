...
class TestAuthentication:
    ...
    async def test_register_duplicate_email(self, async_client: AsyncClient, test_user: User):
        ...
        user_data = {"email": test_user.email, "username": "different", "password": "testpass123"}
    ...
    async def test_register_duplicate_username(self, async_client: AsyncClient, test_user: User):
        ...
        user_data = {"email": "different@example.com", "username": test_user.username, "password": "testpass123"}
    ...
    async def test_register_invalid_email(self, async_client: AsyncClient):
        ...
        user_data = {"email": "invalid-email", "username": "testuser", "password": "testpass123"}
    ...
    async def test_login_success(self, async_client: AsyncClient, test_user: User):
        ...
        login_data = {"identifier": test_user.email, "password": "testpass123"}
    ...
    async def test_login_with_username(self, async_client: AsyncClient, test_user: User):
        ...
        login_data = {"identifier": test_user.username, "password": "testpass123"}
    ...
    async def test_login_invalid_credentials(self, async_client: AsyncClient, test_user: User):
        ...
        login_data = {"identifier": test_user.email, "password": "wrongpassword"}
    ...
    async def test_login_nonexistent_user(self, async_client: AsyncClient):
        ...
        login_data = {"identifier": "nonexistent@example.com", "password": "testpass123"}
...
class TestAPIKeys:
    ...
    async def test_create_api_key(self, async_client: AsyncClient, auth_headers: dict):
        ...
        key_data = {"name": "Test API Key", "expires_in_days": 30}
...
class TestAdminEndpoints:
    ...
    async def test_deactivate_user_admin(self, async_client: AsyncClient, admin_auth_headers: dict, test_user: User):
        ...
        response = await async_client.patch(f"/api/auth/users/{test_user.id}/deactivate", headers=admin_auth_headers)
    ...
    async def test_activate_user_admin(self, async_client: AsyncClient, admin_auth_headers: dict, test_user: User):
        ...
        response = await async_client.patch(f"/api/auth/users/{test_user.id}/activate", headers=admin_auth_headers)
...
class TestPasswordUtils:
    ...
    def test_token_creation(self, test_user: User):
        ...
        token = create_access_token(subject=test_user.email, user_id=test_user.id, role=test_user.role)
