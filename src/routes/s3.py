...
from src.models.s3 import S3Object, S3ObjectResponse, S3ObjectCreate
...
async def list_objects(
    ...
    objects = await S3Object.get_multi(
        db,
        skip=skip,
        limit=size,
        filters=filters,
    ...
    object_responses = [
        S3ObjectResponse.from_orm_with_url(obj)
        for obj in objects
    ]
    
    return PaginatedResponse.create(
        items=object_responses,
        total=total,
        page=page,
        size=size
    )
