...
class Settings(BaseSettings):
    ...
    password_require_uppercase: bool = Field(default=False, description="Require uppercase in passwords")
    password_require_lowercase: bool = Field(default=False, description="Require lowercase in passwords")
    password_require_numbers: bool = Field(default=True, description="Require numbers in passwords")
    password_require_symbols: bool = Field(default=False, description="Require symbols in passwords")
